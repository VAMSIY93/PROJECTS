...
public class drawer_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options=getResources().getStringArray(R.array.admin_array);
...
//                Toast.makeText(getApplicationContext(), "Opened", Toast.LENGTH_SHORT).show();
        ...
        list_fragment.add(new frag5());
        list_fragment.add(new frag6());
