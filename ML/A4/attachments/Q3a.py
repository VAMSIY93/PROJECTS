...
if __name__ == "__main__":
	...
	joblib.dump(clf,'models-svmG/save_model3.pk1')'''
	clf = joblib.load('models-svmG/save_model3.pk1')
	...
	train_accuracy = clf.score(train,train_label)

	prediction = clf.predict(test)
	np.savetxt('prediction-svm-simple.txt',prediction)
