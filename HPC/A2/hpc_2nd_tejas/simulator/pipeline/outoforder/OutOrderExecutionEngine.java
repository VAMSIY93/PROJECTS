...
public class OutOrderExecutionEngine extends ExecutionEngine {
	...
	public long getNumberOfLoads() {
		return reorderBuffer.loadCount;
	}

	@Override
	public long getNumberOfMispredictedLoads() {
		return reorderBuffer.lsmispredCount;
	}	

	@Override
	public long getTotalMemoryInstruction() {
		return reorderBuffer.TotalMemoryInstruction;
	}	

	@Override
	public long getTotalLoadActuallyTrue() {
		return reorderBuffer.TotalLoadActuallyTrue;
	}	

	@Override
	public long getTotalLoadPredictedTrue() {
		return reorderBuffer.TotalLoadPredictedTrue;
	}	
