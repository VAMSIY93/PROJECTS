...
public abstract class ExecutionEngine {
	...
	private LSPredictor lsPredictor;	
	...
	public ExecutionEngine(Core containingCore)
	{
		...
		if(coreConfig.lsPredictor.predictorMode == LSP.AnyStore)
			this.lsPredictor = new AnyStore(this);
		else if(coreConfig.lsPredictor.predictorMode == LSP.StoreSet)
			this.lsPredictor = new StoreSet(this);
	}
	...
	public LSPredictor getLSPredictor() {
		return lsPredictor;
	}
	...
	public abstract long getNumberOfMispredictedLoads();
	...
	public abstract long getTotalMemoryInstruction();
	public abstract long getTotalLoadPredictedTrue();
	public abstract long getTotalLoadActuallyTrue();
